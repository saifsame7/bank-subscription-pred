...
plt.boxplot(x='education', y='age', data=df_cleaned, ax=axs[1, 1],labels=['Basic (4 years)','Basic (6 years)','Basic (9 years)','High School','Professional Course','University Degree','Illiterate']))
